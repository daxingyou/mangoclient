...
cc.wxAPI = function () {
            ...
            wx.setUserCloudStorage(
                {
                    ...
                    success: function (args) {
                        cc.log("wxAPI ->  setUserCloudStorage sucess .", args);
                    },
                    fail: function (args) {
    ...
    ///显示子域
    api.Show = function (num) { 
        this.SendMessage(constants.MessageType.Show, num); 
    }

    ///隐藏子域
    api.Hide = function () { 
        this.SendMessage(constants.MessageType.Hide); 
    }

    ///清空显示
    api.Clear = function () { 
        this.SendMessage(constants.MessageType.Clear); 
    }
