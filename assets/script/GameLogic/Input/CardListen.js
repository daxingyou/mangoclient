...
cc.Class({
    ...
    onLoad () {
        ...
        {
            if(!this.cardItem.CurCenterCard)
            {
                ...
                this.node.on('touchmove', function ( event ) {
                    ...
                    if(cc.pDistance(event.currentTouch._startPoint,event.currentTouch._point) > 5 && dataCenter.returnAniEnd){
                     //   cc.log(dataCenter.returnAniEnd,"dataCenter.returnAniEnd 要显示线了");
                        ...
                        ctx.clear();
                        mgr.CancleSelectCard(that.cardItem._index,event.currentTouch.__instanceId,event.touch._point,cc.pDistance(event.currentTouch._startPoint,event.currentTouch._point) > 5 && dataCenter.returnAniEnd);
                      //  cc.log(dataCenter.returnAniEnd,"dataCenter.returnAniEnd 要隐藏线了");
                    }
